...
from layers.decompositions import DFTDecomp, TrendDecomp
from layers.embed import DataEmbedding_wo_pos
from layers.standard_norm import Normalize
...
class PastDecomposableMixing(nn.Module):
    def __init__(self, configs):
        ...
        if configs.decomp_method == "moving_avg":
            self.decompsition = TrendDecomp(configs.moving_avg)
        elif configs.decomp_method == "dft_decomp":
            self.decompsition = DFTDecomp(configs.top_k)
        else:
...
class TimeMixer(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.preprocess = TrendDecomp(configs.moving_avg)
